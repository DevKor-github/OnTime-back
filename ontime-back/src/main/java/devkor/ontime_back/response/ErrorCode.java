...
public enum ErrorCode {
    ...
    SCHEDULE_NOT_FOUND(1010, "해당 약속이 존재하지 않습니다.", HttpStatus.NOT_FOUND),
    ...
    SCHEDULE_ALREADY_FINISHED(1015, "Finished schedules cannot be edited.", HttpStatus.CONFLICT),
    SCHEDULE_ID_MISMATCH(1016, "경로의 scheduleId와 요청 본문의 scheduleId가 일치하지 않습니다.", HttpStatus.BAD_REQUEST),
    SCHEDULE_ALREADY_STARTED(1017, "Started schedules cannot be edited.", HttpStatus.CONFLICT),
    SCHEDULE_NOT_STARTED(1018, "Schedules must be started before they can be finished.", HttpStatus.CONFLICT),
    ...
    PREPARATION_TEMPLATE_NOT_FOUND(1201, "PREPARATION_TEMPLATE_NOT_FOUND", HttpStatus.NOT_FOUND),
    PREPARATION_TEMPLATE_NAME_DUPLICATE(1202, "PREPARATION_TEMPLATE_NAME_DUPLICATE", HttpStatus.CONFLICT),
    PREPARATION_TEMPLATE_LIMIT_EXCEEDED(1203, "PREPARATION_TEMPLATE_LIMIT_EXCEEDED", HttpStatus.CONFLICT),
    PREPARATION_TEMPLATE_DELETED(1204, "PREPARATION_TEMPLATE_DELETED", HttpStatus.CONFLICT),
    PREPARATION_STEP_ID_CONFLICT(1205, "PREPARATION_STEP_ID_CONFLICT", HttpStatus.CONFLICT),
